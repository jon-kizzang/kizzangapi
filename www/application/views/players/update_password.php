        ...
        <div id="email_body_wrap">
            <div style="height: 66px;width: 600px;float:left;">
                ...
                <div style="background-color:#e2f4ff; width: 600px; height: 100px;">
                    ...
                    <h5 style="text-align: center;"> Password was reset, please click the link below to login with new password</h5>
                    
                    <h5 style="text-align: center;">
                        <a href="http://KizzangWebLoadBalancer-692873250.us-east-1.elb.amazonaws.com/accounts/login">Login</a>
                    </h5>
                </div>
