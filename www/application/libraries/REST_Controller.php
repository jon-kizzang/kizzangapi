    ...
    */
    ...
    public function _remap($object_called, $arguments)
    {
        ...
        if (config_item('rest_enable_keys') and $use_key and $this->_allow === false) {
            ...
            if($controller_method != "image_get" && $controller_method != "ppStatus_post" && $controller_method != "email_action_post")
    ...
    {
         if((is_array($data) && isset($data['code']) && $data['code'] != 0) || (is_object($data) && isset($data->code) && $data->code != 0))
         {
